...
func (x *UpstreamInventoryOneOf) GetStopHeartbeat() *UpstreamInventoryStopHeartbeat {
	if x != nil {
		if x, ok := x.Msg.(*UpstreamInventoryOneOf_StopHeartbeat); ok {
...
const file_inventory_proto_rawDesc = "" +
	"\n" +
	"\x0finventory.proto\x12\x05proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a!teleport/legacy/types/types.proto\x1a'teleport/presence/v1/relay_server.proto\"\xa1\x03\n" +
...
func file_inventory_proto_init() {
	...
	file_inventory_proto_msgTypes[0].OneofWrappers = []any{
