...
// 	protoc        v6.33.3
// source: requestable_roles.proto
...
func (x *ListRequestableRolesRequest) Reset() {
	*x = ListRequestableRolesRequest{}
	mi := &file_requestable_roles_proto_msgTypes[0]
...
func (*ListRequestableRolesRequest) Descriptor() ([]byte, []int) {
	return file_requestable_roles_proto_rawDescGZIP(), []int{0}
}
...
func (x *ListRequestableRolesResponse) Reset() {
	*x = ListRequestableRolesResponse{}
	mi := &file_requestable_roles_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListRequestableRolesResponse) Descriptor() ([]byte, []int) {
	return file_requestable_roles_proto_rawDescGZIP(), []int{1}
}
...
func (x *ListRequestableRolesRequest_Filter) Reset() {
	*x = ListRequestableRolesRequest_Filter{}
	mi := &file_requestable_roles_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListRequestableRolesRequest_Filter) Descriptor() ([]byte, []int) {
	return file_requestable_roles_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ListRequestableRolesResponse_RequestableRole) Reset() {
	*x = ListRequestableRolesResponse_RequestableRole{}
	mi := &file_requestable_roles_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListRequestableRolesResponse_RequestableRole) Descriptor() ([]byte, []int) {
	return file_requestable_roles_proto_rawDescGZIP(), []int{1, 0}
}
...
var File_requestable_roles_proto protoreflect.FileDescriptor

const file_requestable_roles_proto_rawDesc = "" +
	"\n" +
	"\x17requestable_roles.proto\x12\x05proto\"\xcf\x01\n" +
...
var (
	file_requestable_roles_proto_rawDescOnce sync.Once
	file_requestable_roles_proto_rawDescData []byte
)

func file_requestable_roles_proto_rawDescGZIP() []byte {
	file_requestable_roles_proto_rawDescOnce.Do(func() {
		file_requestable_roles_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_requestable_roles_proto_rawDesc), len(file_requestable_roles_proto_rawDesc)))
	})
	return file_requestable_roles_proto_rawDescData
}

var file_requestable_roles_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_requestable_roles_proto_goTypes = []any{
...
var file_requestable_roles_proto_depIdxs = []int32{
...
func init() { file_requestable_roles_proto_init() }
func file_requestable_roles_proto_init() {
	if File_requestable_roles_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_requestable_roles_proto_rawDesc), len(file_requestable_roles_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_requestable_roles_proto_goTypes,
		DependencyIndexes: file_requestable_roles_proto_depIdxs,
		MessageInfos:      file_requestable_roles_proto_msgTypes,
	}.Build()
	File_requestable_roles_proto = out.File
	file_requestable_roles_proto_goTypes = nil
	file_requestable_roles_proto_depIdxs = nil
}
