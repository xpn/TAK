...
func (UnimplementedTransportServiceServer) GetClusterDetails(context.Context, *GetClusterDetailsRequest) (*GetClusterDetailsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetClusterDetails not implemented")
}
func (UnimplementedTransportServiceServer) ProxySSH(grpc.BidiStreamingServer[ProxySSHRequest, ProxySSHResponse]) error {
	return status.Error(codes.Unimplemented, "method ProxySSH not implemented")
}
func (UnimplementedTransportServiceServer) ProxyCluster(grpc.BidiStreamingServer[ProxyClusterRequest, ProxyClusterResponse]) error {
	return status.Error(codes.Unimplemented, "method ProxyCluster not implemented")
}
func (UnimplementedTransportServiceServer) ProxyWindowsDesktopSession(grpc.BidiStreamingServer[ProxyWindowsDesktopSessionRequest, ProxyWindowsDesktopSessionResponse]) error {
	return status.Error(codes.Unimplemented, "method ProxyWindowsDesktopSession not implemented")
}
...
var TransportService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/proto/teleport/transport/v1/transport_service.proto",
}
