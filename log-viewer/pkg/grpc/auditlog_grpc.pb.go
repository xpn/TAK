...
func (UnimplementedAuditLogServiceServer) StreamUnstructuredSessionEvents(*StreamUnstructuredSessionEventsRequest, grpc.ServerStreamingServer[EventUnstructured]) error {
	return status.Error(codes.Unimplemented, "method StreamUnstructuredSessionEvents not implemented")
}
func (UnimplementedAuditLogServiceServer) GetUnstructuredEvents(context.Context, *GetUnstructuredEventsRequest) (*EventsUnstructured, error) {
	return nil, status.Error(codes.Unimplemented, "method GetUnstructuredEvents not implemented")
}
func (UnimplementedAuditLogServiceServer) ExportUnstructuredEvents(*ExportUnstructuredEventsRequest, grpc.ServerStreamingServer[ExportEventUnstructured]) error {
	return status.Error(codes.Unimplemented, "method ExportUnstructuredEvents not implemented")
}
func (UnimplementedAuditLogServiceServer) GetEventExportChunks(*GetEventExportChunksRequest, grpc.ServerStreamingServer[EventExportChunk]) error {
	return status.Error(codes.Unimplemented, "method GetEventExportChunks not implemented")
}
