...
func (x *EventsUnstructured) Reset() {
	*x = EventsUnstructured{}
	mi := &file_auditlog_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EventsUnstructured) Descriptor() ([]byte, []int) {
	return file_auditlog_proto_rawDescGZIP(), []int{2}
}
...
func (x *ExportUnstructuredEventsRequest) Reset() {
	*x = ExportUnstructuredEventsRequest{}
	mi := &file_auditlog_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExportUnstructuredEventsRequest) Descriptor() ([]byte, []int) {
	return file_auditlog_proto_rawDescGZIP(), []int{3}
}
...
func (x *ExportEventUnstructured) Reset() {
	*x = ExportEventUnstructured{}
	mi := &file_auditlog_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExportEventUnstructured) Descriptor() ([]byte, []int) {
	return file_auditlog_proto_rawDescGZIP(), []int{4}
}
...
func (x *EventUnstructured) Reset() {
	*x = EventUnstructured{}
	mi := &file_auditlog_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EventUnstructured) Descriptor() ([]byte, []int) {
	return file_auditlog_proto_rawDescGZIP(), []int{5}
}
...
func (x *GetEventExportChunksRequest) Reset() {
	*x = GetEventExportChunksRequest{}
	mi := &file_auditlog_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetEventExportChunksRequest) Descriptor() ([]byte, []int) {
	return file_auditlog_proto_rawDescGZIP(), []int{6}
}
...
func (x *EventExportChunk) Reset() {
	*x = EventExportChunk{}
	mi := &file_auditlog_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EventExportChunk) Descriptor() ([]byte, []int) {
	return file_auditlog_proto_rawDescGZIP(), []int{7}
}
...
const file_auditlog_proto_rawDesc = "" +
	"\n" +
	"\x0eauditlog.proto\x12\x14teleport.auditlog.v1\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"h\n" +
...
var (
	...
	file_auditlog_proto_rawDescData []byte
)

func file_auditlog_proto_rawDescGZIP() []byte {
	file_auditlog_proto_rawDescOnce.Do(func() {
		file_auditlog_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_auditlog_proto_rawDesc), len(file_auditlog_proto_rawDesc)))
	})
	return file_auditlog_proto_rawDescData
}

var file_auditlog_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_auditlog_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_auditlog_proto_goTypes = []any{
...
func file_auditlog_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_auditlog_proto_rawDesc), len(file_auditlog_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
